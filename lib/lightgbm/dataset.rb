module LightGBM
  class Dataset
    ...
    def initialize(data, label: nil, weight: nil, params: nil, reference: nil, used_indices: nil)
      @data = data
    ...
    def subset(used_indices, params: nil)
      params ||= self.params
      Dataset.new(nil, params: params, reference: self, used_indices: used_indices)
    end
